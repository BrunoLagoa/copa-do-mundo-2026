...
2. **Eliminatórias** — bracket interativo com seleção de vencedores
3. **TeamPage** — campo 3D SVG com formação tática, elenco em tabela, jogos/resultados
4. **PlayerModal** — portal sobre o campo, avatar DiceBear, stats geradas, CTA para perfil
5. **PlayerPage** — perfil completo do jogador com hero, stats, companheiros de posição
6. **Dark/Light mode** — ThemeToggler animate-ui + next-themes, toggle binário light↔dark
